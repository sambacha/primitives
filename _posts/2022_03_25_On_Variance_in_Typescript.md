...
Notice that this is _unlike_ the dynamics in nominal type systems, where unless
...
In general by the rules of variance, we would expect that narrowing the return
