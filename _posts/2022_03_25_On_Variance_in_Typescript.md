...
description: structural typing and the combination of inference with pervasive mutability in typescript
tags: typescript, languages, type, higher order type operations, design
---

## On Variance in TypeScript

There are several complicating factors for the discussion of variance in TypeScript:
